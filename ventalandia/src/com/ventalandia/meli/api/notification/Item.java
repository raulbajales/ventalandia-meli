...
public class Item{
	...
	public List<NonMercadoPagoPaymentMethod> getNon_mercado_pago_payment_methods() {
		return non_mercado_pago_payment_methods;
	}
	public void setNon_mercado_pago_payment_methods(List<NonMercadoPagoPaymentMethod> non_mercado_pago_payment_methods) {
